...
class UseCasesConfiguration {
    ...
    @Bean
    ListAllCampaignsUseCase listAllCampaignsUseCase(Campaigns campaigns) {
        return ListAllCampaignsUseCase.defaultService(campaigns);
    }
}
